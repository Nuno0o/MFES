...
public class Producer {
  ...
  public void sendProducts() {
    ...
    Number n = 0L;
    Number s = 0L;
    for (Iterator iterator_14 = MapUtil.dom(stocks.products).iterator(); iterator_14.hasNext(); ) {
      String product = (String) iterator_14.next();
      n = 0L;
      for (Iterator iterator_15 = delegations.iterator(); iterator_15.hasNext(); ) {
        Delegation delegation = (Delegation) iterator_15.next();
