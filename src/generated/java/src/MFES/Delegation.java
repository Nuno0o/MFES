...
public class Delegation {
  ...
  public void makeBaskets() {
    ...
    for (Iterator iterator_11 = customers.iterator(); iterator_11.hasNext(); ) {
      Consumer customer = (Consumer) iterator_11.next();
      makeBasket(customer);
    }
  }
  ...
  public void fillBasket(final Consumer C) {
    ...
    for (Iterator iterator_13 = products.iterator(); iterator_13.hasNext(); ) {
      String p = (String) iterator_13.next();
      {
  ...
  public void fillBaskets() {
    ...
    for (Iterator iterator_14 = customers.iterator(); iterator_14.hasNext(); ) {
      Consumer c = (Consumer) iterator_14.next();
      fillBasket(c);
    }
  }
  ...
  public static String highest(final VDMMap P) {
    ...
    return highestaux(Utils.copy(P), "None", -1L);
  }
